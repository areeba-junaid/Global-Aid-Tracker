...
function AidOfferList() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (aidFormFilter === "asset") {
          apiUrl = "http://localhost:5000/api/assetOffer/all-donor-asset-list";
        } else if (aidFormFilter === "fund") {
          apiUrl = "http://localhost:5000/api/aidOffer/all";
        }
  ...
  return (
    <div className="w-5/6 mt-10 p-4 m-auto ">
      <h1 className="text-3xl font-semibold text-center">Aid Offers</h1>
